...
def sd_model_download():
  ...
  os.system(f"aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://download.openxlab.org.cn/models/Tinsley/realisticasianthaila/weight//DreamShaper_8_pruned.safetensors -d /home/xlab-app-center/models/stable-diffusion -o DreamShaper_8_pruned.safetensors")
  os.system(f"aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://download.openxlab.org.cn/models/Tinsley/realisticasianthaila/weight//rev-animated-v1-2-2.safetensors -d /home/xlab-app-center/models/stable-diffusion -o rev-animated-v1-2-2.safetensors")
